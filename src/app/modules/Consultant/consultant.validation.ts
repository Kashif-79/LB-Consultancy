...
export const createConsultantValidationSchema = z.object({
  body: z.object({
    consultant: z.object({
...
export const updateConsultantValidationSchema = z.object({
  body: z.object({
    consultant: z
      .object({
        name: userNameZodSchema,
...
export const consultantValidations = {
  createConsultantValidationSchema,
  updateConsultantValidationSchema,
};
